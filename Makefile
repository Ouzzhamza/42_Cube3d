SRCS  = ./src/cube3d_utiles/free.c ./src/cube3d_utiles/ft_isprint.c ./src/cube3d_utiles/ft_lstlast.c ./src/cube3d_utiles/ft_lstsize.c ./src/cube3d_utiles/ft_is_space.c\
		...
		./src/raycasting/raycasting_utils.c ./src/cube3d.c ./src/errors/error.c ./src/mini_map/draw_line.c ./src/hooks/player_move.c ./src/hooks/hooks.c \
		./src/hooks/hook_utiles.c ./src/hooks/player_move_utiles.c ./src/errors/free_functions.c ./src/parsing_map/map_parcing.c ./src/raycasting/rays_distance.c \
		...
		./src/cube3d_utiles/ft_substr.c ./src/cube3d_utiles/ft_fa_split.c 
